...
$allTools = @(
    ...
    @{ Name="Bytecode-Viewer";             Url="https://github.com/Konloch/bytecode-viewer/releases/download/v2.13.2/Bytecode-Viewer-2.13.2.jar";                                                                                                                                                                                    File="Bytecode-Viewer-2.13.2.jar" },
